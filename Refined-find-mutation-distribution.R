...
gene_data <- read.csv("/Users/ulfurfjolnisson/Downloads/The Epigenetic Machinery.csv", header = TRUE)
...
# Process each gene name from the temporary file
temp_gene_names <- readLines("temp_gene_names.txt")
output_file <- "output-3.txt"
