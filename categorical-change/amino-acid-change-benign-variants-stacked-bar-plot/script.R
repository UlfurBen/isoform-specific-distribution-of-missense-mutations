...
file1 <- "homo_sapiens_variation_missense_ClinVar_benign_likely_benign_only_EM_genes_aa_change_count.txt"
file2 <- "homo_sapiens_variation_missense_ClinVar_benign_likely_benign_only_all_genes_aa_change_count.txt"
